...
var chartS11N = {
	...
	defdef: "<ChartaCaeli xmlns='http://www.chartacaeli.org/model' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xsi:schemaLocation='http://www.chartacaeli.org/model chartacaeli.xsd'/>",

	// XML declaration and any further required prolog
	XMLdec: "<?xml version='1.0' encoding='UTF-8'?>",

	// specification (XSD) transformed to Xonomy
	Xonomy: {
		elements: {
			"Cartesian": {
				menu: [{
